...
import { AlignLeft, Bold, Heading1, Heading2, Heading3, ImagePlus, Italic, Link2, List, ListOrdered, Paperclip, X } from 'lucide-react';
...
export default ProjectCreationMain
